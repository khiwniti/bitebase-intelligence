...
export const MAP_CONFIG = {
  MAPBOX_TOKEN: process.env.NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN || 'pk.eyJ1Ijoia2hpd25pdGkiLCJhIjoiY205eDFwMzl0MHY1YzJscjB3bm4xcnh5ZyJ9.ANGVE0tiA9NslBn8ft_9fQ',
...
export const FEATURES = {
  ...
  ENABLE_REAL_DATA: process.env.NEXT_PUBLIC_ENABLE_REAL_DATA === 'true',
